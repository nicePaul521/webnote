<template>
  <div style="text-align: initial;">
    <el-card class="box-card" shadow="hover" v-for="(item,i) in visibleNotes" :key="i">
      <div slot="header" class="clearfix">
        ...
        <el-tooltip transition="0s" class="item" effect="dark" content="编辑笔记内容" placement="top-start">
          <el-button class="note-operation" type="text" @click="editNote(item.id)">
    ...
    <el-row style="position: fixed;bottom: 10px;right: 10px">
      <el-button type="primary" circle @click="editCategory">
        <i class="el-icon-edit"></i>
      </el-button>
    </el-row>

    <el-row style="position: fixed;bottom: 70px;right: 10px">
      <el-button type="success" circle @click="addNote">
