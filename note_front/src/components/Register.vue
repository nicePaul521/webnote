  ...
  <div class="container">
    <div class="form-body">
      ...
      <el-form ref="form" :model="registerForm" label-width="0px">
        ...
        <el-form-item>
          <el-input placeholder="请输入确认密码" v-model="registerForm.passwordConfirm" show-password></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="onSubmit" class="form-confirm">立即创建</el-button>
        </el-form-item>
<!--        <el-form-item>-->
